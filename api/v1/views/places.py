...
def list_all_places(city_id):
    """Reviews a list of all Places in a City"""
...
def list_place(place_id):
    """Retrieves a specific instance of Place, otherwise 404 error"""
...
def delete_place(place_id):
    """Delete a specific instance of Place, otherwise 404 error"""
    place = storage.get('Place', place_id)
    if place is None:
        abort(404)
